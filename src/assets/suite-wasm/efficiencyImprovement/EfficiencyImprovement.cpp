...
EMSCRIPTEN_BINDINGS(efficiency_improvement_class)
{
    //probably refactor to return output object on ::calculate() (similar too pumpShaftPower)
    //currently from js you call .getNewFuelSavings() to get "newFuelSavings" value since it is marked private
